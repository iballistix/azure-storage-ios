...
NSInteger const AZSCMaxBlockSize = (AZSCKilobyte * AZSCKilobyte) / 2;
...
NSString *const AZSCHeaderValueUserAgent = @"Azure-Storage/0.2.2-preview (iOS %@)";
...
NSString *const AZSCQueryRestypeService = @"restype=service";
...
NSString *const AZSCXmlCors = @"Cors";
NSString *const AZSCXmlCorsAllowedHeaders = @"AllowedHeaders";
NSString *const AZSCXmlCorsAllowedMethods = @"AllowedMethods";
NSString *const AZSCXmlCorsAllowedOrigins = @"AllowedOrigins";
NSString *const AZSCXmlCorsExposedHeaders = @"ExposedHeaders";
NSString *const AZSCXmlCorsMaxAgeInSeconds = @"MaxAgeInSeconds";
NSString *const AZSCXmlCorsRule = @"CorsRule";
NSString *const AZSCXmlDefaultServiceVersion = @"DefaultServiceVersion";
NSString *const AZSCXmlEnabled = @"Enabled";
...
NSString *const AZSCXmlIncludeAPIs = @"IncludeAPIs";
...
NSString *const AZSCXmlLogging = @"Logging";
NSString *const AZSCXmlLoggingDelete = @"Delete";
NSString *const AZSCXmlLoggingRead = @"Read";
NSString *const AZSCXmlLoggingWrite = @"Write";
NSString *const AZSCXmlMessage = @"Message";
NSString *const AZSCXmlMetadata = @"Metadata";
NSString *const AZSCXmlMetricsHourMetrics = @"HourMetrics";
NSString *const AZSCXmlMetricsIncludeAPIs = @"IncludeAPIs";
NSString *const AZSCXmlMetricsMinuteMetrics = @"MinuteMetrics";
...
NSString *const AZSCXmlRetentionPolicy = @"RetentionPolicy";
NSString *const AZSCXmlRetentionPolicyDays = @"Days";
NSString *const AZSCXmlStorageServiceProperties = @"StorageServiceProperties";
...
NSString *const AZSCXmlVersion = @"Version";
